...
class CustomerRegistrationView(View):
    ...
    def post(self,request):
        ...
        if form.is_valid():
            form.save()
            messages.success(request,'conngraturations user registration successful')
        else:
...
class ProfileView(View):
    ...
    def post(self,request):
        ...
        if form.is_valid():
            ...
            reg.save()   
            messages.success(request,'conngraturations profile saved successfully') 
        else:
            messages.error(request,'invalid input data') 
        return render(request,'app/profile.html',locals())
...
def add_to_cart(request):
    ...
    cart_item = Cart.objects.filter(product=product)
    if cart_item.exists():
        return HttpResponse("Cart Object Already Exist")
    else:
